"""
TalentIQ - Advanced Recruitment Intelligence Platform
...
st.set_page_config(
    ...
    menu_items={
        'About': "TalentIQ - Next-Gen Recruitment Intelligence Platform"
    }
)
...
class TalentIQApp:
    ...
    def settings_tab(self):
        ...
        with tab3:
            st.markdown("### About TalentIQ™")
            
            st.markdown("""
            #### Version 2.0.0
            
            TalentIQ is an advanced AI-powered recruitment intelligence platform designed to 
            ...
            **Support:**
            - Documentation: [docs.talentiq.ai](https://docs.talentiq.ai)
